...
<section class="about py-lg-4 py-md-4 py-sm-3 py-3" id="about" style="margin-top: 30px;">
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <div class="d-flex justify-content-between" style="margin: 20px;">
            <div class="p-2"><h5 style="color: #bf3718; font-size: 20pt"><strong>จัดการข้อมูลร้านสปา</strong></h5></div>
            <div class="p-2"><a href="{{ route('add-spa') }}" type="button" class="btn
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 60px">รหัส</th>
                        <th class="text-center" style="width: 300px">ชื่อร้าน</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                                <form action="{{ route('delete-spa',$item->id) }}" method="post">
                                        @method('DELETE')
                                        @csrf
