...
<section class="about py-lg-4 py-md-4 py-sm-3 py-3" id="about"
    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <div class="d-flex justify-content-between" style="margin: 20px;">
            <div class="p-2"><h5 style="color: #bf3718; font-size: 20pt"><strong>แก้ไขข้อมูลร้านสปา</strong></h5></div>
        </div>
        <div class="card">
            <div class="card-body">
                    <form action="{{ route('edit-spa-store',['id' => $spa->id]) }}" method="post" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <input required type="text" class="form-control" id="address"
                                        name="address" value="{{ $spa->address }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <input required type="text" class="form-control" id="district"
                                        name="district" value="{{ $spa->district }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <input required type="text" class="form-control" id="province"
                                        name="province" value="{{ $spa->province }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <input required pattern="[0-9]{5}" type="text" class="form-control" id="zipcode"
                                        name="zipcode" value="{{ $spa->zipcode }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <input pattern="{0-9}" type="text" class="form-control" id="phone"
                                        name="phone" min="9" max="10" maxlength="10" value="{{ $spa->phone }}">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    <textarea class="form-control" id="detail"
                                        name="detail">{{ $spa->detail }}</textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <input required type="text" class="form-control"
                                                id="price" name="price" value="{{ $spa->price }}">
                                        </div>
                                        <div class="col-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="row">
                                        <div class="col-5">
                                            <input required type="text" class="form-control"
                                                id="worktime_start" name="worktime_start" value="{{ $spa->worktime_start }}">
                                        </div>
                                        <div class="col-1">
                                            -
                                        </div>
                                        <div class="col-5">
                                            <input required type="text" class="form-control"
                                                id="worktime_stop" name="worktime_stop" value="{{ $spa->worktime_stop }}">
                                        </div>
