...
<section class="about py-lg-4 py-md-4 py-sm-3 py-3" id="about"
    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <div class="d-flex justify-content-between" style="margin: 20px;">
            <div class="p-2"><h5 style="color: #bf3718; font-size: 20pt"><strong>เพิ่มข้อมูลผลิตภัณฑ์สมุนไพร</strong></h5></div>
        </div>
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 text-right">
                            <p style="color: #111; font-size: 13pt">ชื่อผลิตภัณฑ์สมุนไพร <span style="color: red;">*</span></p>
                        </div>
                        <div class="col-lg-5">
